...
namespace AdminSite.SiteAttributes.Policys.UserPolicy
{
    public class RoleRequirement : IAuthorizationRequirement
    {
        ...
        public async Task<bool> IsAuth(IEnumerable<Guid> roleList, string areaName, string controllerName, string actionName)
        {
            ...
            return await _userRoleJurisdictionService.ExistsAsync(a => a.MenuID == menu.ID && roleList.Contains(a.RoleID));
        }
    }
}
