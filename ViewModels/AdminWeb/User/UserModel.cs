...
namespace XL.Admin.ViewModel.Account
{
    ...
    public class UserStroe : IUserStore<User>
    {
    ...
    public class ApplicationSignInManager : SignInManager<User>
    {
        ...
        public ApplicationSignInManager(UserManager<User> userManager, IHttpContextAccessor contextAccessor,
            ...
            ILogger<SignInManager<User>> logger , IAuthenticationSchemeProvider provider) : base(userManager, contextAccessor, claimsFactory, optionsAccessor,
            logger , provider)
        {
        }
    }
